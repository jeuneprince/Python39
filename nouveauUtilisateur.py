...
prenom= Label(logo, text="Prenom",bg="black", font=('arial',12,'bold'), fg="#fff")
prenom.place(x=490,y=100)

tel= Label(logo, text="Telephone",bg="black", font=('arial',12,'bold'), fg="#fff")
tel.place(x=310,y=160)

courriel= Label(logo, text="Courriel",bg="black", font=('arial',12,'bold'), fg="#fff")
courriel.place(x=490,y=160)

addr= Label(logo, text="Adresse",bg="black", font=('arial',12,'bold'), fg="#fff")
addr.place(x=310,y=220)

ide= Label(logo, text="Username",bg="black", font=('arial',12,'bold'), fg="#fff")
ide.place(x=600,y=220)

mdp= Label(logo, text="Password",bg="black", font=('arial',12,'bold'), fg="#fff")
